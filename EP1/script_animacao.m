...
for ti=1:30:numel(t)
    ...
    x2e=L1*sin(theta(1,ti)) +L2e*sin(theta(2,ti))-cos(theta(2,ti))*l;
    y2e=-L1*cos(theta(1,ti)) -L2e*cos(theta(2,ti))-sin(theta(2,ti))*l;
    x2d=L1*sin(theta(1,ti)) +L2e*sin(theta(2,ti))+cos(theta(2,ti))*l;
    y2d=-L1*cos(theta(1,ti)) -L2e*cos(theta(2,ti))+sin(theta(2,ti))*l;
